...
def test_get_assets_reraises_unexpected_authentication_error(
    mock_sumo_client: tuple[MagicMock, MagicMock],
) -> None:
    """Tests that an unexpected authentication error is re-raised."""
...
def test_login_reraises_unexpected_authentication_error(
    mock_sumo_client: tuple[MagicMock, MagicMock],
) -> None:
    """Tests that client construction handling does not mask auth errors."""
    _, client = mock_sumo_client
    authentication_error = RuntimeError("Unexpected authentication error")
    client.authenticate.side_effect = authentication_error
